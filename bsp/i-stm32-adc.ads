...
package Interfaces.STM32.ADC is
   ...
   subtype CSR_AWD1_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_EOC1_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_JEOC1_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_JSTRT1_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_STRT1_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_OVR1_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_AWD2_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_EOC2_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_JEOC2_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_JSTRT2_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_STRT2_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_OVR2_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_AWD3_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_EOC3_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_JEOC3_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_JSTRT3_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_STRT3_Field is Interfaces.Bit_Types.Bit;
   subtype CSR_OVR3_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CCR_DDS_Field is Interfaces.Bit_Types.Bit;
   subtype CCR_DMA_Field is Interfaces.Bit_Types.UInt2;
   subtype CCR_ADCPRE_Field is Interfaces.Bit_Types.UInt2;
   subtype CCR_VBATE_Field is Interfaces.Bit_Types.Bit;
   subtype CCR_TSVREFE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CR1_OVRIE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CR2_DDS_Field is Interfaces.Bit_Types.Bit;
   subtype CR2_EOCS_Field is Interfaces.Bit_Types.Bit;
   ...
   type ADC1_Peripheral is record
      ...
      SMPR1 : Interfaces.Bit_Types.Word;
      --  sample time register 2
      SMPR2 : Interfaces.Bit_Types.Word;
      --  injected channel data offset register x
